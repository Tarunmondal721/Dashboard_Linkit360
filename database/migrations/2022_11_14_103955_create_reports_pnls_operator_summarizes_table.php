...
class CreateReportsPnlsOperatorSummarizesTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        if ( !Schema::hasTable('reports_pnls_operator_summarizes') ) {
            Schema::create('reports_pnls_operator_summarizes', function (Blueprint $table) {
                $table->id();
    ...
    {
        Schema::dropIfExists('reports_pnls_operator_summarizes');
    }
}
