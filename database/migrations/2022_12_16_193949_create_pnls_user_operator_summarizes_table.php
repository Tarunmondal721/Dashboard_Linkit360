...
class CreatePnlsUserOperatorSummarizesTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
    	...
    	if (!Schema::hasTable('pnls_user_operator_summarizes')) {


        Schema::create('pnls_user_operator_summarizes', function (Blueprint $table) {
            $table->id();
            ...
            $table->unique(['id_operator','user_id','date']);
    ...
    {
        Schema::dropIfExists('pnls_user_operator_summarizes');
    }
}
