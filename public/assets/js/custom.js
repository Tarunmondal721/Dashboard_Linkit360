...
function commonLoader() {
    ...
    function RevenueCal() {
        var operator_share = document.getElementById("opt-share").value;
        var merchent_share = 100-operator_share;

        document.querySelector('input[name="merchant_revenue_share"]').value = merchent_share;
    }

    function RevenueDateCal() {
        var operator_share = document.getElementById("opt-share-date").value;
        var merchent_share = 100-operator_share;

        document.querySelector('input[name="merchant_revenue_share_date"]').value = merchent_share;
    }
