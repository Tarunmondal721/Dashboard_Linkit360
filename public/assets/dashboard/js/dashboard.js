...
$(function(){
	...
	if(path == "/report/summary" || path == "/report/summary/country" || path == "/report/summary/manager" || path == "/report/summary/business"){
		callGraph('t_revenue');
		mixedGraph();
		mixedAxesGraph();
	}
	if(path == "/report/summary/monthly" || path == "/report/summary/monthly/country" || path == "/report/summary/monthly/manager" || path == "/report/summary/monthly/business"){
...
$('.service-xls').on('click', function(){
	var param = $(this).data('param')
	$('#'+param+' h1').text('Reporting Service Details '+param.toUpperCase())
	$('#'+param).excelexportjs({
		containerid: param,
		datatype: 'table'
	});
...
$('.monitor-xls').on('click', function(){
	var param = $(this).data('param')
	// $('#'+param+' h1').text('Monitor Operational '+param.toUpperCase())
	$('#'+param).excelexportjs({
		containerid: param,
		datatype: 'table'
	});
