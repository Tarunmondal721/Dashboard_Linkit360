<div class="card bg-none card-box">
    {{ Form::model($country, array('route' => array('countries.update', $country->id), 'method' => 'POST', 'enctype' => 'multipart/form-data')) }}
    <div class="row">
        ...
        <div class="col-12 form-group">
            <div class="choose-file">
                <label class="form-control-label">
                    ...
                    <input class="form-control" name="flag" type="file" id="flag" accept="image/*" data-filename=""/>
                </label>
