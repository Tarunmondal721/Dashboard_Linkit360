...
<div class="card shadow-sm mt-0">
  <div class="card-body">
        ...
        <div class="col-lg-2">
            ...
            <div class="form-group">
                <select class="form-control select2" name="data_type" id="data_type" style="width: 100%" data-select2-id="select2-data-1-qgws" tabindex="-1" aria-hidden="true">
                    <option value="country"{{Request::route()->getName() == 'finance.targetRevenue' ? 'selected' : ''}}>Country Summary</option>
                    <option value="company"{{Request::route()->getName() == 'finance.targetRevenue.company' ? 'selected' : ''}}>Company Summary</option>
                </select>
            </div>
        </div>
    ...
    <a href="{{ route('finance.createTargetRevenueReconcile') }}" class="btn btn-primary"><i class="fa fa-plus"></i> Add New Target Revenue </a>
    <a href="{{ route('finance.createTargetOpex') }}" class="btn btn-primary"><i class="fa fa-plus"></i> Add Opex per company</a>
  </div>
</div>
<div class="d-flex align-items-center my-3">
  <span class="badge badge-secondary px-2 bg-primary text-uppercase">Target Revenue <?= isset($req_year) ? $req_year : date('Y'); ?></span>
...
<script>
  ...
  function submit(){
    ...
    var urls= window.location.origin+'/finance/targetRevenue';
