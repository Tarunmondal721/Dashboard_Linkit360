...
<div class="card shadow-sm mt-0">
  <div class="card-body">
    ...
    <a href="{{ route('finance.createFinanceCostReport') }}" class="btn btn-primary"><i class="fa fa-plus"></i> Add New Finance Budget </a>
  </div>
</div>
<div class="d-flex align-items-center my-3">
  <span class="badge badge-secondary px-2 bg-primary text-uppercase">Finance Budget <?= isset($req_year) ? $req_year : date('Y'); ?></span>
...
<script>
  ...
  function submit(){
    ...
    var urls= window.location.origin+'/finance/financeCostReport';
