                    ...
                    <div class="col-md-4">
                        ...
                        <div class="form-group">
                            <select class="form-control select2" name="data" style="width: 100%" data-select2-id="select2-data-4-cvqm" tabindex="-1" aria-hidden="true" id="data">
                                <option value="daily" data-select2-id="select2-data-6-on6w"{{Request::route()->getName() == 'analytic.monitor.daily.operator'?'selected': ''}}>Daily Reports</option>
                                <option value="monthly"{{Request::route()->getName() == 'analytic.monitor.monthly.operator'  || Request::route()->getName() == 'analytic.monitor.monthly.country' ?'selected': ''}}>Monthly Reports</option>
                            </select>
                        </div>
                    </div>
                    <div class="col-md-4">
                        ...
                        <div class="form-group">
                            <select class="form-control select2" name="data_type" id="data_type" style="width: 100%" data-select2-id="select2-data-1-qgws" tabindex="-1" aria-hidden="true">
                                ...
                                <option value="operator" data-select2-id="select2-data-3-u0zv" {{Request::route()->getName() == 'analytic.monitor.monthly.operator'?'selected': ''}}>Operator Summary
                                </option>
                                <option value="country"{{Request::route()->getName() == 'analytic.monitor.monthly.country' || Request::route()->getName() == 'analytic.monitor.daily.country' ?'selected': ''}}>Country Summary</option>
