    ...
    <div class="row">
      ...
      <div class="col-lg-2">
        ...
        <select name="report_type" class="form-control select2" required id="report_type">
          <option value="operator" <?php echo isset($OperatorWise) ? 'selected': '' ?>>Operator Summary</option>
          <option value="country" <?php echo isset($CountryWise) ? 'selected': '' ?>>Country Summary</option>
          <option value="company" <?php echo isset($CompanyWise) ? 'selected': '' ?>>Company Summary</option>
          <option value="business" <?php echo isset($BusinessWise) ? 'selected': '' ?>>Business Type Summary</option>
        </select>
      </div>
      ...
      <div class="col-lg-3">
        ...
        <select name="operator" class="form-control select2" required multiple id="operator">
          <option value="">Operator Name</option>
          @foreach ($operators as $operator)
          <option value="{{$operator->id_operator}}"<?php echo isset($filterOperator) && (in_array($operator->id_operator, $filterOperator)) ? 'selected': '' ?> >{{$operator->operator_name}}</option>
          @endforeach
        </select>
      </div>
      ...
      <div class="col-4 row <?php echo !isset($custom_range)? 'gu-hide': '' ?>" id="date_range_faield">
        <div class="col-lg-6">
      ...
      <div class="col-lg-2">
        ...
        <div class="form-group">
          <select class="simple-multiple-select select2" name="data_base_on" id="data_base">
            <option value="highest_usd_end_user_revenue">Highest Revenue(USD)</option>
            <option value="lowest_usd_end_user_revenue">Lowest Revenue(USD)</option>
      ...
      {{--<div class="col-lg-2">
        ...
        <button class="btn btn-sm pnl-xls" style="color:white; background-color:green" data-param="reportXls"><i class="fa fa-file-excel-o"></i>Export All as XLS</button>
      </div>--}}

      @if(isset($unknown_operator) && !empty($unknown_operator))
      <div class="col-lg-3">
        <div class="d-block" style="white-space: nowrap;">Unknown Count : {{$unknown_operator}}</div>
        <div><a href="{{ route('report.unknown_operator') }}" style="padding:10px 20px;" class="btn btn-primary">Unknown Operators</a></div>
      </div>
      @endif
    </div>
  </div>
