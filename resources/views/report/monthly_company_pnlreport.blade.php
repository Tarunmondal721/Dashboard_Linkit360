...
<div class="page-content">
  ...
  <div class="card shadow-sm mt-0">
    <div class="card-body">
      <div class="d-flex align-items-center my-3">
        <span class="badge badge-with-flag badge-secondary px-2 bg-primary text-uppercase">All {{ isset($BusinessWise) ? 'Business Types': 'Companies'}} {{isset($report['month_string'] ) ? $report['month_string'] : ''}} </span>
          ...
          <table class="table table-light m-0 font-13 table-text-no-wrap" id="pnlTbl">
            ...
            <tbody>
              ...
              <tr class="bg-young-green pnl">
                <td class="font-weight-bold"><strong class="text-with-sup">GP<sup><i class="ml-3 text-dark fa fa-info-circle" title="GP = Net Revenue - (Cost Campaign + other cost)"></i></sup></strong></td>
  ...
  <div id="container">
    ...
    <div class="ptable">
      <div class="d-flex align-items-center my-3">
        <span class="badge badge-with-flag badge-secondary px-2 bg-primary text-uppercase"><?php echo $report['company']['name'] ?? 'unknown'; ?> | {{$report['month_string']}} | Last Update: {{isset($report['last_update'])?$report['last_update']:''}}</span>
        <span class="flex-fill ml-2 bg-primary w-100 font-weight-bold" style="height: 1px;"></span>
        <div class="text-right pl-2">
      ...
      <div class="card">
        <div class="table-responsive shadow-sm pnlDataTbl" id="Indonesia">
          <h1 style="display:none">GP Summary For Indonesia, Nov 2022</h1>
          <table class="table table-light m-0 font-13 table-text-no-wrap" id="pnlTbl">
            <thead class="thead-dark">
              <tr>
                <th>Summary</th>
