    ...
    <div class="ptable">
      <div class="d-flex align-items-center my-3">
        <span class="badge badge-with-flag badge-secondary px-2 bg-primary text-uppercase">
          ...
          {{$report['country']['country_code']}} <a href="{{ route('report.details','?operator='.$report['operator']->id_operator) }}" class="text-white">{{isset($report['operator']->display_name) && $report['operator']->display_name ? $report['operator']->display_name : $report['operator']->operator_name}} </a>{{$report['month_string']}} | Last Update: {{$report['last_update']}} </span>
        <span class="flex-fill ml-2 bg-primary w-100 font-weight-bold" style="height: 1px;"></span>
        <div class="text-right pl-2">
          ...
          <table class="table table-light m-0 font-13 table-text-no-wrap" id="pnlTbl">
            ...
            <tbody>
              ...
              <tr class="bg-young-yellow hiddenOtherCostTr" style="display: none;">
                <td class="font-weight-bold">
                  <div style="font-weight: bolder; position: relative; left: 30px;">Hosting Cost {{$report['hostingCost']}}%</div>
                </td>
              ...
              <tr class="bg-young-yellow hiddenOtherCostTr" style="display: none;">
                <td class="font-weight-bold">
                  <div style="font-weight: bolder; position: relative; left: 30px;">Content {{$report['contentCost']}}%</div>
                </td>
                <td class="content_total">{{numberConverter( $report['content']['total'],2,'pre') }}</td>
                <td class="content_avg">{{numberConverter( $report['content']['avg'],2,'pre') }}</td>
                <td class="content_month">{{numberConverter( $report['content']['t_mo_end'],2,'pre') }}</td>
              ...
              <tr class="bg-young-yellow hiddenOtherCostTr" style="display: none;">
                ...
                <td class="md_total">{{numberConverter( $report['rnd']['total'],2,'pre') }}</td>
                <td class="md_avg">{{numberConverter( $report['rnd']['avg'],2,'pre') }}</td>
                <td class="md_month">{{numberConverter( $report['rnd']['t_mo_end'],2,'pre') }}</td>
              ...
              <tr class="bg-young-yellow hiddenOtherCostTr" style="display: none;">
                <td class="font-weight-bold">
                  <div style="font-weight: bolder; position: relative; left: 30px;">BD {{$report['bdCost']}}%</div>
                </td>
                <td class="bd_total">{{numberConverter( $report['bd']['total'],2,'pre') }}</td>
                <td class="bd_avg">{{numberConverter( $report['bd']['avg'],2,'pre') }}</td>
                <td class="bd_month">{{numberConverter( $report['bd']['t_mo_end'],2,'pre') }}</td>
              ...
              <tr class="bg-young-yellow hiddenOtherCostTr" style="display: none;">
                <td class="font-weight-bold">
                  <div style="font-weight: bolder; position: relative; left: 30px;">Marketing Cost {{$report['marketCost']}}%</div>
                </td>
