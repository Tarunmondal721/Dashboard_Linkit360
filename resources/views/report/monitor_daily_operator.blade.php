                            ...
                            <tr class=" country-odd-bg">
                                ...
                                <td>
                                    ...
                                    <p class="font-weight-bold roi-value">
                                        {{ isset($totelCountryCost['roi']) ? numberConverter($totelCountryCost['roi']['dates'][$date]['value'], 4, 'pre') : 0 }}
                                    </p>
                                    <p class="font-weight-bold mo-value">
