    ...
    <div class="row justify-content-between align-items-center">
      <div class="col-xl-4 col-lg-4 col-md-4 d-flex align-items-center justify-content-between justify-content-md-start mb-3 mb-md-0">
        <div class="d-inline-block">
          ...
          <p class="d-inline-block font-weight-200 mb-0">Reconcialiation of Country Data</p>
        </div>
      </div>
  ...
  <div id="reportXls">
    <div class="d-flex align-items-center my-3">
      <span class="badge badge-secondary px-2 bg-primary text-uppercase">
        <a href="" class="text-white">ALL COUNTRY </a>@if(isset($allsummaryData) && !empty($allsummaryData)){{$allsummaryData['month_string']}}@endif
      </span>
    ...
    <div class="ptable">
      <div class="d-flex align-items-center my-3">
        <span class="badge badge-secondary px-2 bg-primary text-uppercase">
          ...
          {{$report['country']['country_code']}} {{$report['country']['country']}} {{$report['month_string']}} | Last Update: {{$report['last_update']}}
        </span>
        <span class="flex-fill ml-2 bg-primary w-100 font-weight-bold" style="height: 1px;"></span>
        <div class="text-right pl-2">
          <button class="btn btn-sm report-xls" style="color:white; background-color:green" data-param="{{$report['country']['country']}}"><i class="fa fa-file-excel-o"></i>Export as XLS</button>
        </div>
      </div>
