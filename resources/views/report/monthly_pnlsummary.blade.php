    ...
    <div class="row justify-content-between align-items-center">
      <div class="col-xl-4 col-lg-4 col-md-4 d-flex align-items-center justify-content-between justify-content-md-start mb-3 mb-md-0">
        ...
        <div class="d-inline-block">
          ...
          <p class="d-inline-block font-weight-200 mb-0">Details of Operator Data</p>
        </div>
        @endif
      </div>
  ...
  <div class="card shadow-sm mt-0">
    <div class="card-body">
      <div class="d-flex align-items-center my-3">
        <span class="badge badge-with-flag badge-secondary px-2 bg-primary text-uppercase">All Operators {{isset($report['month_string'] ) ? $report['month_string'] : ''}} </span>
    ...
    <div class="ptable">
      <div class="d-flex align-items-center my-3">
        <span class="badge badge-with-flag badge-secondary px-2 bg-primary text-uppercase">
          <img src="{{ asset('/flags/'.$report['country']['flag']) }}" alt="{{$report['country']['country']}}" width="30">&nbsp;{{$report['country']['country_code']}} <a href="{{ route('report.details','?operator='.$report['operator']->id_operator) }}" class="text-white">{{isset($report['operator']->display_name) && $report['operator']->display_name ? $report['operator']->display_name : $report['operator']->operator_name}} </a>{{$report['month_string']}} | Last Update: {{isset($report['last_update'])?$report['last_update']:''}}
        </span>
        <span class="flex-fill ml-2 bg-primary w-100 font-weight-bold" style="height: 1px;"></span>
        <div class="text-right pl-2">
          <button class="btn btn-sm pnl-xls" style="color:white; background-color:green" data-param="{{$report['operator']->operator_name}}"><i class="fa fa-file-excel-o"></i>Export as XLS</button>
        </div>
      </div>
      <div class="card">
        <div class="table-responsive shadow-sm pnlDataTbl" id="{{$report['operator']->operator_name}}">
          ...
          <table class="table table-light m-0 font-13 table-text-no-wrap" id="pnlTbl">
            ...
            <tbody>
              ...
              <tr class="bg-young-yellow hiddenOtherTaxTr" style="display: none;">
                <td class="font-weight-bold">
                  <div style="font-weight: bolder; position: relative; left: 30px;">WHT {{$report['whtTax']}}%</div>
                </td>
              ...
              <tr class="bg-young-yellow hiddenOtherTaxTr" style="display: none;">
                <td class="font-weight-bold">
                  <div style="font-weight: bolder; position: relative; left: 30px;">MISC TAX {{$report['miscTax']}}%</div>
                </td>
            ...
            <tbody>
                ...
                <tr class="bg-old-blue hiddenOtherCostTr" style="display: none;">
                  <td class="font-weight-bold">
                    <div style="font-weight: bolder; position: relative; left: 30px;">Misc Cost {{$report['miscCost']}}%</div>
                  </td>
