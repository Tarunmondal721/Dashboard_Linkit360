        ...
        <div class="row justify-content-between align-items-center">
          <div
            ...
            <div class="d-inline-block">
              ...
              <p class="d-inline-block font-weight-200 mb-0">{{ isset($BusinessWise) ? 'Summary of Business Data': 'Summary of Company Data'}}</p>
            </div>
            @endif
            @if(isset($sumOfSummaryData['net_after_tax']))
            <div class="d-inline-block">
              <h5 class="h4 d-inline-block font-weight-400 mb-0"><b>GP Details</b></h5><br>
              <p class="d-inline-block font-weight-200 mb-0">Details of Company Data</p>
            </div>
            @endif
          </div>
          <div
      ...
      <div class="card-body">
        ...
        <div class="d-flex align-items-center my-3">
          <span class="badge badge-with-flag badge-secondary px-2 bg-primary text-uppercase">
            All {{ isset($BusinessWise) ? 'Business Types': 'Companies'}} {{isset($report['month_string'] ) ? $report['month_string'] : ''}} </span>
            ...
            <table class="table table-light m-0 font-13 table-text-no-wrap" id="pnlTbl">
              ...
              <tbody>
                ...
                <tr class="bg-young-blue end_user_revenue">
                  ...
                  <td class="gross_revenue_usd_total">{{numberConverter( $end_user_rev_usd['total'] ,2,'hosting_cost','') }}</td>
                  <td class="gross_revenue_usd_avg">{{numberConverter( $end_user_rev_usd['avg'] ,2,'hosting_cost','') }}</td>
                  <td class="gross_revenue_usd_month">{{numberConverter( $end_user_rev_usd['t_mo_end'] ,2,'hosting_cost','') }}</td>
                  @if(isset($end_user_rev_usd['dates']) && !empty($end_user_rev_usd['dates']))
                  @foreach ($end_user_rev_usd['dates'] as $rev_usd)
                      <td class="gross_revenue_usd_data">{{numberConverter( $rev_usd['value'] ,2,'hosting_cost','') }}</td>
                  @endforeach
                  @endif
                </tr>
                @endif
                ...
                <tr class="bg-young-blue gross_revenue">
                  ...
                  <td class="share_total">{{numberConverter( $gros_rev_usd['total'] ,2,'hosting_cost','') }}</td>
                  <td class="share_avg">{{numberConverter( $gros_rev_usd['avg'] ,2,'hosting_cost','') }}</td>
                  <td class="share_month">{{numberConverter( $gros_rev_usd['t_mo_end'] ,2,'hosting_cost','') }}</td>

                  @if(isset($gros_rev_usd['dates']) && !empty($gros_rev_usd['dates']))
                  @foreach ($gros_rev_usd['dates'] as $gros_rev)
                      <td class="share_data">{{numberConverter( $gros_rev['value'] ,2,'hosting_cost','') }}</td>
                  @endforeach
                  @endif
                </tr>
                @endif
                ...
                <tr class="bg-young-yellow o_cost">
                  ...
                  <td class="other_cost_total">{{numberConverter( $other_cost['total'] ,2,'hosting_cost','') }}</td>
                  <td class="other_cost_avg">{{numberConverter( $other_cost['avg'] ,2,'hosting_cost','') }}</td>
                  <td class="other_cost_month">{{numberConverter( $other_cost['t_mo_end'] ,2,'hosting_cost','') }}</td>

                  @if(isset($other_cost['dates']) && !empty($other_cost['dates']))
                  @foreach ($other_cost['dates'] as $othercost)
                      <td class="other_cost_data">{{numberConverter( $othercost['value'] ,2,'hosting_cost','') }}</td>
                  @endforeach
                  @endif
                </tr>
                @endif
                ...
                <tr class="bg-young-yellow hiddenSoSOtherCostTr" style="display: none;">
                  ...
                  <td class="hosting_cost_total">{{numberConverter( $hosting_cost['total'] ,2,'hosting_cost','') }}</td>
                  <td class="hosting_cost_avg">{{numberConverter( $hosting_cost['avg'] ,2,'hosting_cost','') }}</td>
                  <td class="hosting_cost_month">{{numberConverter( $hosting_cost['t_mo_end'] ,2,'hosting_cost','') }}</td>

                  @if(isset($hosting_cost['dates']) && !empty($hosting_cost['dates']))
                  @foreach ($hosting_cost['dates'] as $hostingcost)
                    <td class="hosting_cost_data">{{numberConverter( $hostingcost['value'] ,2,'hosting_cost','') }}</td>
                  @endforeach
                  @endif
                </tr>
                @endif
                ...
                <tr class="bg-young-yellow hiddenSoSOtherCostTr" style="display: none;">
                  ...
                  <td class="content_total">{{numberConverter( $content['total'] ,2,'hosting_cost','') }}</td>
                  <td class="content_avg">{{numberConverter( $content['avg'] ,2,'hosting_cost','') }}</td>
                  <td class="content_month">{{numberConverter( $content['t_mo_end'] ,2,'hosting_cost','') }}</td>

                  @if(isset($content['dates']) && !empty($content['dates']))
                  @foreach ($content['dates'] as $contentdata)
                      <td class="content_data">{{numberConverter( $contentdata['value'] ,2,'hosting_cost','') }}</td>
                  @endforeach
                  @endif
                </tr>
                @endif
                ...
                <tr class="bg-young-yellow hiddenSoSOtherCostTr" style="display: none;">
                  ...
                  <td class="md_total">{{numberConverter( $rnd['total'] ,2,'hosting_cost','') }}</td>
                  <td class="md_avg">{{numberConverter( $rnd['avg'] ,2,'hosting_cost','') }}</td>
                  <td class="md_month">{{numberConverter( $rnd['t_mo_end'] ,2,'hosting_cost','') }}</td>
                  @if(isset($rnd['dates']) && !empty($rnd['dates']))
                  @foreach ($rnd['dates'] as $rnddata)
                      <td class="md_data">{{numberConverter( $rnddata['value'] ,2,'hosting_cost','') }}</td>
                  @endforeach
                  @endif
                </tr>
                @endif
                ...
                <tr class="bg-young-yellow hiddenSoSOtherCostTr" style="display: none;">
                  ...
                  <td class="bd_total">{{numberConverter( $bd['total'] ,2,'hosting_cost','') }}</td>
                  <td class="bd_avg">{{numberConverter( $bd['avg'] ,2,'hosting_cost','') }}</td>
                  <td class="bd_month">{{numberConverter( $bd['t_mo_end'] ,2,'hosting_cost','') }}</td>
                  @if(isset($bd['dates']) && !empty($bd['dates']))
                  @foreach ($bd['dates'] as $bddata)
                      <td class="bd_data">{{numberConverter( $bddata['value'] ,2,'hosting_cost','') }}</td>
                  @endforeach
                  @endif
                </tr>
                @endif
                ...
                <tr class="bg-young-yellow hiddenSoSOtherCostTr" style="display: none;">
                  ...
                  <td class="platform_total">{{numberConverter( $platform['total'] ,2,'hosting_cost','') }}</td>
                  <td class="platform_avg">{{numberConverter( $platform['avg'] ,2,'hosting_cost','') }}</td>
                  <td class="platform_month">{{numberConverter( $platform['t_mo_end'] ,2,'hosting_cost','') }}</td>
                  @if(isset($platform['dates']) && !empty($platform['dates']))
                  @foreach ($platform['dates'] as $platformdata)
                      <td class="platform_data">{{numberConverter( $platformdata['value'] ,2,'hosting_cost','') }}</td>
                  @endforeach
                  @endif
                </tr>
                @endif
                ...
                <tr class="bg-young-yellow o_tax">
                  <td class="font-weight-bold">
                    <div class="text-with-sup">
                      ...
                      <div class="text-left"><strong class="text-with-sup">Other Tax<sup><i
                              class="ml-3 text-dark fa fa-info-circle"
                              title="Other Tax = Vat + Wht + Misc Tax"></i></sup></strong></div>
                    </div>
                  </td>
                  <td class="other_tax_total">{{numberConverter( $other_tax['total'],2,'pre') }}</td>
                  {{-- <td class="other_tax_total">{{numberConverter($other_tax['total'] }}</td> --}}
                ...
                <tr class="bg-young-green pnl">
                  <td class="font-weight-bold"><strong class="text-with-sup">GP<sup><i
                          class="ml-3 text-dark fa fa-info-circle"
                          title="GP = Net Revenue - (Cost Campaign + other cost)"></i></sup></strong>
                  </td>
                  <td class="pnl_total">{{numberConverter( $pnl['total'] ,2,'hosting_cost','') }}</td>
                  <td class="pnl_avg">{{numberConverter( $pnl['avg'] ,2,'hosting_cost','') }}</td>
                  <td class="pnl_month">{{numberConverter( $pnl['t_mo_end'] ,2,'hosting_cost','') }}</td>

                  @if(isset($pnl['dates']) && !empty($pnl['dates']))
                  @foreach ($pnl['dates'] as $pnldata)
                      <td class="pnl_data">{{numberConverter( $pnldata['value'] ,2,'hosting_cost','') }}</td>
                  @endforeach
                  @endif
                </tr>
                @endif
              ...
              <tbody>
                ...
                <tr class="bg-young-yellow gross_revenue">
                  <td class="font-weight-bold">
                    <div class="text-with-sup">
                      <strong class="text-with-sup">Net Revenue (USD)<sup><i
                            class="ml-3 text-dark fa fa-info-circle" title="gross revenue USD - other tax"></i></sup></strong>
                    </div>
                  </td>
    ...
    <div class="ptable">
      <div class="d-flex align-items-center my-3">
        <span class="badge badge-with-flag badge-secondary px-2 bg-primary text-uppercase">
            ...
            <?php echo $report['company']['name'] ?? 'unknown'; ?>|
                {{$report['month_string']}} | Last Update: {{$report['last_update']}} </span>
        <span class="flex-fill ml-2 bg-primary w-100 font-weight-bold" style="height: 1px;"></span>
        <div class="text-right pl-2">
          <button class="btn btn-sm pnl-xls" style="color:white; background-color:green" data-param="<?php echo $report['company']['name'] ?? 'unknown'; ?>
            "><i
              class="fa fa-file-excel-o"></i>Export as XLS</button>
        </div>
      </div>
      <div class="card">
        <div class="table-responsive shadow-sm pnlDataTbl" id="<?php echo $report['company']['name'] ?? 'unknown'; ?>
            ">
          <table class="table table-light m-0 font-13 table-text-no-wrap" id="pnlTbl">
            <thead class="thead-dark">
              <tr>
            ...
            <tbody>
              ...
              <tr class="bg-young-blue end_user_revenue">
                ...
                <td class="gross_revenue_usd_avg">{{numberConverter($report['end_user_rev_usd']['avg'] ,2,'hosting_cost','') }}</td>
                <td class="gross_revenue_usd_month">{{numberConverter($report['end_user_rev_usd']['t_mo_end'] ,2,'hosting_cost','') }}</td>
              ...
              {{-- <tr class="bg-young-blue hiddenRevTr" style="display: none;">
                ...
                <td class="gross_revenue_avg">{{numberConverter( $report['end_user_rev']['avg'] ,2,'hosting_cost','') }}</td>
                <td class="gross_revenue_month">{{numberConverter( $report['end_user_rev']['t_mo_end'] ,2,'hosting_cost','') }}</td>
              ...
              <tr class="bg-young-blue gross_revenue">
                ...
                <td class="share_avg">{{numberConverter( $report['gros_rev_usd']['avg'] ,2,'hosting_cost','') }}</td>
                <td class="share_month">{{numberConverter( $report['gros_rev_usd']['t_mo_end'] ,2,'hosting_cost','') }}</td>
              ...
              {{-- <tr class="bg-young-blue hiddenGrossRevUsdTr" style="display:none;">
                ...
                <td class="local_share_avg">{{numberConverter( $report['gros_rev']['avg'] ,2,'hosting_cost','') }}</td>
                <td class="local_share_month">{{numberConverter( $report['gros_rev']['t_mo_end'] ,2,'hosting_cost','') }}</td>
              ...
              <tr class="bg-young-yellow hiddenOtherCostTr" style="display: none;">
                ...
                <td class="hosting_cost_avg">{{numberConverter( $report['hosting_cost']['avg'] ,2,'hosting_cost','') }}</td>
                <td class="hosting_cost_month">{{numberConverter( $report['hosting_cost']['t_mo_end'] ,2,'hosting_cost','') }}</td>
              ...
              <tr class="bg-young-yellow hiddenOtherCostTr" style="display: none;">
                ...
                <td class="market_cost_total">{{numberConverter( $report['market_cost']['total'],2,'pre') }}</td>
                <td class="market_cost_avg">{{numberConverter( $report['market_cost']['avg'],2,'pre') }}</td>
                <td class="market_cost_month">{{numberConverter( $report['market_cost']['t_mo_end'],2,'pre') }}</td>

                @if(isset($report['market_cost']['dates'] ) && !empty($report['market_cost']['dates'] ))
                @foreach ($report['market_cost']['dates'] as $market_cost)
              ...
              <tr class="bg-young-green pnl">
                ...
                <td class="pnl_avg">{{numberConverter( $report['pnl']['avg'] ,2,'hosting_cost','') }}</td>
                <td class="pnl_month">{{numberConverter( $report['pnl']['t_mo_end'] ,2,'hosting_cost','') }}</td>
            ...
            <tbody>
                ...
                <tr class="bg-old-yellow arpu_7">
                  ...
                  <td class="arpu_7_month">{{numberConverter( $report['arpu_7_usd']['avg'] ,4,'hosting_cost') }}</td>

                  <td class="arpu_7_avg">N/A</td>

                  @if(isset($report['arpu_7_usd']['dates']) && !empty($report['arpu_7_usd']['dates']))
                  @foreach ($report['arpu_7_usd']['dates'] as $arpu_7_usd)
