      ...
      <div class="row justify-content-between align-items-center">
        <div
          ...
          <div class="d-inline-block">
            <!-- <h5 class="h4 d-inline-block font-weight-400 mb-0 ">GP Details
            </h5> -->
            <div>Summary of Campaign Data</div>
          </div>
        </div>
      </div>
    </div>
      ...
      <div class="card-body">
        ...
        <div class="d-flex align-items-center my-3">
          <span class="badge badge-with-flag badge-secondary px-2 bg-primary text-uppercase">
            GP Details {{isset($report['month_string'] ) ? $report['month_string'] : ''}} </span>
