                            ...
                            <tr class=" country-odd-bg">
                                ...
                                <td>
                                    <p class="font-weight-bold ">
                                        {{ isset($totelCountryCost['roi']) ? numberConverter($totelCountryCost['roi']['avg'], 4, '') : 0 }}
                                    </p>
                                </td>
                                {{-- <td>
                                    <p class="font-weight-bold">
                            ...
                            @if (is_array($totelCountryCost['operator']) &&
                                ...
                                @foreach ($totelCountryCost['operator'] as $operator)
                                    <tr class="{{ isset($countryClass) ? $countryClass : '' }}  expandable operator-odd-bg"
                                        ...
                                        <td class="subs">
                                            <p>
                                                {{ isset($operator['roi']['avg']) ? numberConverter($operator['roi']['avg'], 4, '') : 0 }}
                                            </p>
                                        </td>
                                        ...
                                        @if (isset($operator['roi']['dates']) || !empty($operator['roi']['dates']))
                                            @foreach ($no_of_days as $no_of_day)
                                                <td>
                                                    <p class="font-weight-bold">
