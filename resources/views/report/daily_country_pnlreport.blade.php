      ...
      <div class="card-body">
        ...
        <div class="d-flex align-items-center my-3">
          <span class="badge badge-with-flag badge-secondary px-2 bg-primary text-uppercase">
            All Countries {{isset($report['month_string'] ) ? $report['month_string'] : ''}} </span>
          ...
          <table class="table table-light m-0 font-13 table-text-no-wrap" id="pnlTbl">
            ...
            <tbody>
              ...
              <tr class="bg-young-blue end_user_revenue">
                ...
                <td class="gross_revenue_usd_total usd">{{numberConverter($report['end_user_rev_usd']['total'],2)}} </td>
                <td class="gross_revenue_usd_avg">{{numberConverter($report['end_user_rev_usd']['avg'],2)}}</td>
                <td class="gross_revenue_usd_month">{{numberConverter($report['end_user_rev_usd']['t_mo_end'],2)}}</td>
                ...
                @foreach ($report['end_user_rev_usd']['dates'] as $end_user_rev_usd)
                    <td class="gross_revenue_usd_data {{$end_user_rev_usd['class']}}">{{numberConverter($end_user_rev_usd['value'],2)}}</td>
                @endforeach
                @endif
              </tr>
              ...
              <tr class="bg-young-yellow hiddenOtherCostTr" style="display: none;">
                ...
                <td class="platform_total">{{numberConverter( $report['platform']['total'],2,'post','%') }}</td>
                <td class="platform_avg">{{numberConverter( $report['platform']['avg'],2,'post','%') }}</td>
                <td class="platform_month">{{numberConverter( $report['platform']['t_mo_end'],2,'post','%') }}</td>
