...
@section('content')
    ...
    <div class="page-content page-content-center">
        ...
        <form action="{{ route('report.product.update') }}" method="POST" onsubmit="return productSubmit()">
            @csrf
                    ...
                    <div class="row" style="margin-top: 10px;">
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control fild-Style" id="name" name="name" aria-describedby="emailHelp" placeholder="Input product name" value="{{isset($product)?$product->name:''}}">
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input type="url" class="form-control fild-Style" id="doman" name="doman"  aria-describedby="emailHelp" placeholder="Input doman" value="{{isset($product)?$product->doman:''}}">
                                <span class="gu-hide" style="color: red;"
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control fild-Style" id="analytical_id" name="analytical_id"
                                    aria-describedby="emailHelp" placeholder="Input analytical Id" value="{{isset($product)?$product->analytical_id:''}}">
                                <span class="gu-hide" style="color: red;"
