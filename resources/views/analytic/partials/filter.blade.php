                ...
                <div class="row">
                    <div class="col-md-3">
                        ...
                        <div class="form-group">
                            <select class="form-control select2" name="data_type" id="data_type" style="width: 100%" data-select2-id="select2-data-1-qgws" tabindex="-1" aria-hidden="true">
                                ...
                                <option value="operator" data-select2-id="select2-data-3-u0zv" {{Request::route()->getName() == 'analytic.adsMonitoring'?'selected': ''}}>Operator Summary
                                </option>
                                <option value="country"{{Request::route()->getName() == 'analytic.adsMonitoring.country'?'selected': ''}}>Country Summary</option>
                                <option value="company"{{Request::route()->getName() == 'analytic.adsMonitoring.company'?'selected': ''}}>Company Summary</option>
                                <option value="business"{{Request::route()->getName() == 'analytic.adsMonitoring.business'?'selected': ''}}>Business Summary</option>
                            </select>
                        </div>
                    </div>
                    ...
                    <div class="col-md-3">
                        ...
                        <select name="date_range" class="form-control select2" required id="date_range" onchange="date_ranges()">
                                ...
                                <option value="&to={{date('Y-m-01', strtotime(date('Y-m-d')))}}&from={{date('Y-m-t', strtotime(date('Y-m-d')))}}">This Month</option>
                                @php
                    ...
                    <div class="col-md-3">
                        <div class="form-group">
                            ...
                            <button type="button" class="btn btn-primary ads_submit"><i class="fa fa-sort"></i>
                                Sort</button>
                        </div>
                    </div>
